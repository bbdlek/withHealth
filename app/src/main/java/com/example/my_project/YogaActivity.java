    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnplo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ad.setTitle("플로 자세");
                ad.setMessage("1. 바닥에 등을 대고 누워서 시작합니다.\n" +
        ...
        btnplank.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ad.setMessage("1. 엉덩이로 앉은 후, 두 다리를 뻗고, 팔과 다리로 몸을 지탱합니다.\n" +
        ...
        btnchair.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder ad=new AlertDialog.Builder(YogaActivity.this);
                ad.setTitle("체어 자세");
                ad.setMessage("1. 바닥에 서서 진행하며 운동하는 내내 복근에 힘을 주고 있어야 합니다.\n" +
        ...
        btnstep.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ad.setMessage("1. 바닥에 엎드려서 손바닥이 어깨 밑에 위치하도록 하고, 손가락은 앞 방향을 가리키고 있는 상태로 시작합니다.\n" +
        ...
        btnboat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder ad=new AlertDialog.Builder(YogaActivity.this);
                ad.setTitle("보트 자세");
                ad.setMessage("1. 바닥에 엉덩이를 대고 앉아 다리를 뻗습니다.\n" +
